...
/**
 * Created by AND I5 on 04-04-2016.
 */
public class CustomEditeText extends EditText {
    ...
    public CustomEditeText(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context, attrs);
    }

    public CustomEditeText(Context context, AttributeSet attrs, int defStyle) {
