...
public class Adapter_TreeSpecies extends RecyclerView.Adapter<ViewHolder> implements Filterable {
    ...
    public Adapter_TreeSpecies(KittenClickListener activity, ArrayList<HashMap<String, String>> mLocation, ArrayList<HashMap<String, byte[]>> mimages, FragmentActivity ac) {
