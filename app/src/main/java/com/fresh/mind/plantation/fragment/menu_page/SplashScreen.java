                            ...
                            try {
                                for (int i = 0; i < result1Array.length(); i++) {
                                    if (Config.checkInternetConenction(getActivity())) {
                                        ...
                                        Log.d("General_Infosdsdsdsd", TreeName + "  " + General_Info);
                                        ...
                                        Log.d("Tree_Charsdsewere", TreeName + " " + Tree_Char);
